...
public class SelectDiaryListServiceTest {
	public static void main(String[] args) {
		...
		//-->import org.apache.logging.log4j.LogManager;
		//-->import org.apache.logging.log4j.Logger;
		Logger logger= LogManager.getFormatterLogger(SelectDiaryListServiceTest.class.getName());
		...
		try {
			//게시물 조회하기
			list = diaryService.selectDiarylist(diary);
