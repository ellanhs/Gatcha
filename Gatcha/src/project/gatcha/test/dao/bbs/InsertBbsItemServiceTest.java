...
//단일 항목 입력 ServiceLayer 테스트베드
public class InsertBbsItemServiceTest {
	public static void main(String[] args) {
		...
		//-->import org.apache.logging.log4j.LogManager;
		//-->import org.apache.logging.log4j.Logger;
		Logger logger= LogManager.getFormatterLogger(InsertBbsItemServiceTest.class.getName());
		...
		try {
			...
			//처리 결과를 로그에 기록하기
			logger.debug("데이터가 저장되었습니다>"+bbs.toString());
		} catch (Exception e) {
