...
//단일 항목 수정 ServiceLayer 테스트베드
public class UpdateBbsItemServiceTest {
	public static void main(String[] args) {
		...
		//-->import org.apache.logging.log4j.LogManager;
		//-->import org.apache.logging.log4j.Logger;
		Logger logger= LogManager.getFormatterLogger(UpdateBbsItemServiceTest.class.getName());
		...
		bbs.setId(5);
		bbs.setMemberId(3);
		bbs.setSubject("빨리빨리 대응해주세요~!!");
		bbs.setContent("글올린게 언제인데 응답이 없습니까!!! 너무하시네요~! 정말로요~!!!");
		...
		try {
			...
			//처리 결과를 로그에 기록하기
			logger.debug("데이터가 수정되었습니다>"+bbs.toString());
		} catch (Exception e) {
