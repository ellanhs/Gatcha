...
import project.gatcha.helper.MailHelper;
import project.gatcha.helper.Util;
...
public class FindPwOk extends BaseController {
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("방귀뿡-------------------------------------------------------"+member.getEmail());
		...
		String sender = "xha@green.com";
		String subject = "Gatcha 비밀번호 변경 안내 입니다.";
