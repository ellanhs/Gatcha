 ...
 */
@WebServlet("/evaluate/evaluate_ok.do")
public class EvaluateOk extends BaseController {

	
	private static final long serialVersionUID = 2974376916602368995L;
   ...
   * insertEvaluateMayNoOne가 실행되어 평가를 추가할것입니다.  */
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result < 1){
			...
			try{
				evaluateService.updateEvaluateChoice(evaluateNext);
			}catch(Exception e){
				e.getLocalizedMessage();
