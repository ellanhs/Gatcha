...
@WebServlet("/mystory/mystory_favorite.do")
public class MystoryFavoriteLike extends BaseController{

	private static final long serialVersionUID = -4432438238638284500L;
	Logger logger;
