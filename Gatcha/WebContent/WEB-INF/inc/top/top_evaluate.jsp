...
<%@ page trimDirectiveWhitespaces="true" %>
		...
		<div class="navbar navbar-default navbar-fixed-top" role="navigation">
			<div class="container">
				...
				<!-- 상단 메뉴 평가매기기 active 상태 -->
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav"> 
						<li class = "active disabled"><a href="${pageContext.request.contextPath}/evaluate/evaluate_main.do?genre_id=0">평가매기기</a></li>
						...
						<li><a href="${pageContext.request.contextPath}/member/edit.do">개인설정</a></li>
					</ul>
					<!-- 상단 메뉴 사용자 -->
