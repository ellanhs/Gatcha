		...
		<div class="col-sm-2 col-md-2 space1">
			<div class="navbar navbar-default" role="navigation">
				<ul class="nav navbar-nav"> 					
					...
					<li class="active disabled"><a href="${pageContext.request.contextPath}/mystory/mystory_favorite_hate.do">관심없어요  <span class="badge">${fn:length(ev_list_hate)}</span></a></li>
					...
					<li><a href="${pageContext.request.contextPath}/mystory/mystory_statistics.do">취향통계분석</a></li>
				</ul>
			</div>
		</div>
		<!-- 왼쪽 하위 메뉴 끝 -->